...
class OauthRetrofitWithMoshiContainerBuilderTest {
    ...
    private lateinit var builder: OauthRetrofitWithMoshiContainerBuilder
    ...
    fun setup() {
        ...
        builder = OauthRetrofitWithMoshiContainerBuilder("clientId", mockAuthenticationLocalStorage, mockSessionExpiredEventHandler)
            .configureRetrofit {
